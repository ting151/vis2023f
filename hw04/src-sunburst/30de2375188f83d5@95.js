...
<h3>從上圖中，我們可以看出：
  <ul>
    <li>工作地點的類型為「工作室」佔了填寫問卷的絕大多數共38.8%的人。其中12.1%的人有採取減少碳排放的行動，是以減少包裝材及文宣印製，8.58%的人有採取減少碳排放的行動，是以使用無毒媒材、再生材料、廢物利用素材等。/li>
    <li>工作地點的類型為「替代空間」佔了填寫問卷的第二大多數，有18.5%的人。其中5.26%的人有採取減少碳排放的行動，是以減少包裝材及文宣印製，5.07% 的人有採取減少碳排放的行動，是以使用無毒媒材、再生材料、廢物利用素材等。</li>
    <li>工作地點的類型為「非營利組織/藝術團體」佔了填寫問卷的第三大多數，有14.8%的人。其中3.51% 的人有採取減少碳排放的行動，是以減少包裝材及文宣印製，3.31%的人有採取減少碳排放的行動，是以使用無毒媒材、再生材料、廢物利用素材等。</li>
    <li>由此圖可見，絕大多數都會採取減少包裝材及文宣印製或是使用無毒媒材、再生材料、廢物利用素材等來減少碳排放的行動。</li>
  </ul>
</h3>`
)}
...
d3
  ...
  .range(["#FFC5C5","#FFEBD8","#C7DCA7","#89B9AD","#F875AA","#FFDFDF"])
  .unknown("#AEDEFC")
)}
